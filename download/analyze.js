...
/**
 * analyze.js — Codebase Graph Analyzer v2.0
 *
 ...
 *
 * Usage:
 *   node analyze.js [path] [--json] [--full] [--stats-only]
 */
...
function main() {
  ...
  console.log('');
  console.log('  ╔═══════════════════════════════════════════════════════════╗');
  console.log('  ║         Codebase Graph Analyzer v2.0                     ║');
  console.log('  ║         Layered: Parse → Store → Graph → Query → View    ║');
  console.log('  ╚═══════════════════════════════════════════════════════════╝');
  console.log('');
  ...
  // ── Step 1: Open storage ──
  console.log('  🗄️  Opening SQLite storage (WAL mode)...');
  ...
  console.log('  🕸️  Building in-memory graph indices...');
  ...
  // ── Step 6: Build helpers and visualization data ──
  console.log('  🏗️  Building visualization data...');
  ...
  if (cycles.length > 0) {
    ...
    if (cycles.length > 5) {
      console.log(`  ║    ... and ${cycles.length - 5} more${' '.repeat(35)}║`);
    }
  }
